  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#F7F8FC] p-4">
      <div className="w-full max-w-md">
        <a href="/login" className="mb-8 flex items-center gap-2 text-sm font-bold text-slate-500 transition hover:text-slate-950">
        ...
        <div className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-slate-100">
          ...
          {sent ? (
            <>
              <h1 className="text-2xl font-extrabold text-slate-950">Email envoyé !</h1>
              <p className="mt-3 text-slate-500">
                Un lien de réinitialisation a été envoyé à <span className="font-bold text-slate-950">{email}</span>. Vérifie ta boîte mail et clique sur le lien.
              </p>
              <p className="mt-3 text-sm text-slate-400">
                Tu n'as pas reçu l'email ? Vérifie tes spams ou{" "}
                <button onClick={() => setSent(false)} className="font-bold text-indigo-600 hover:underline">
                  réessaie
                </button>.
              </p>
            </>
            ...
            <>
              <h1 className="text-2xl font-extrabold text-slate-950">Mot de passe oublié</h1>
